      ...
      <li className="flex items-center">
        ...
        <div className="w-[425px] flex items-center justify-end gap-1">
          ...
          <label>
            ...
            <div className={`check-wrapper duration-220 mb-1 cursor-pointer  rounded-[100%] w-[25px] h-[25px] border-2 border-solid `}>
              <a href="#">
                <img className="hidden" src="src/assets/imgs/result.png" alt="true" />
              </a>
            </div>
          </label>
        </div>
